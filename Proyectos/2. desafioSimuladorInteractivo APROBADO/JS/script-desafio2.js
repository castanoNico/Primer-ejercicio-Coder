...
let n1= parseFloat (prompt ("Ingrese nota uno"))
let n2= parseFloat (prompt ("Ingrese nota dos"))
let n3= parseFloat (prompt ("Ingrese nota tres"))

function promedio(a,b,c) {
   let resultado= (a + b + c) /3     

   if (resultado <4 )  {
    alert ("Usteded esta desaprobado" +resultado)
    }
    else {
        alert ("Usted esta aprobado" +resultado)
     }
}
