...
//      let descripcionJuego = document.getElementById("descripcion-juego1")
...
//let cantidadDeCompras = prompt("Indica la cantidad de Juegos que compraras")
...
// function indiqueJuego(){
//       inputJuego = e.taget.value
// }




// let inputJuego = document.getElementById("comprarJuego")
// inputJuego.addEventListener = () => {indiqueJuego}

// function compra(){

//   for (let i = 0; i < cantidadDeCompras; i++){
    
//     //inputJuego.onchange ("input" , indiqueJuego)
//     //comprarJuego = prompt("indique el juego que quiere comprar:\n " + nombreJuegos.join("\n ")).toLowerCase()
      
//     let botonGOD = document.getElementById("botongod")
//     botonGOD.addEventListener ("click" , function compraGod(){stockCompra(cantidadJuego, juego1)})
    ...
    //   }
      ...
      // if (inputJuego == "god of war"){
      // stockCompra(cantidadJuego, juego1)
      // }

    //   else if (inputJuego == "cuphead"){
    //   stockCompra(cantidadJuego, juego2)
    //   }

    //   else if (inputJuego == "hollow knight"){
    //   stockCompra(cantidadJuego, juego3)
    //   }

    //   else if (inputJuego == "gta v"){
    //   stockCompra(cantidadJuego, juego4)
    //   }

    //   else if (inputJuego == "final fantasy"){
    //   stockCompra(cantidadJuego, juego5)
    //   }

    //   else if (inputJuego == "deep rock galactic"){
